            ...
            <div class="row justify-content-center">
                <div class="col-11 col-md-8">
                    ...
                    <ul>
                        ...
                        <li>Los colores se establecerán aleatoriamente de entre 10 colores preestablecidos. En cada jugada, se informará de cuántos colores has acertado de la combinación y cuántos están en la posición correcta. En caso de acierto, no sabrás cuáles son las posiciones acertadas.</li>
